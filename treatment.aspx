...
<body>
        ...
        <table class="auto-style1">
            <tr>
                <td class="auto-style2">
                    <strong>
                    <asp:Label ID="Label1" runat="server" Text="Treatement ID"></asp:Label>
                    </strong>
                </td>
                <td>
    ...
    <div>
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" SelectCommand="SELECT * FROM [treatment]"></asp:SqlDataSource>
    </form>
</body>
</html>
