...
public partial class Service : System.Web.UI.Page
{
    ...
    protected void Button2_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            SqlDataSource1.SelectCommand = "select * from services ";
    ...
    protected void Button3_Click(object sender, EventArgs e)
    {
        ...
        {
            SqlCommand cmd = conn.CreateCommand();
            cmd.CommandText = "update services set service_name='" + TextBox2.Text + "',fee='" + TextBox3.Text + "',hospital_id='" + TextBox4.Text + "' where service_id='" + TextBox1.Text + "' ";
            cmd.ExecuteNonQuery();
    ...
    protected void Button5_Click(object sender, EventArgs e)
    {
        ...
        {
            SqlCommand cmd = conn.CreateCommand();
            cmd.CommandText = "select * from services where service_id='" + TextBox1.Text + "'";
            SqlDataReader dr = cmd.ExecuteReader();
            while (dr.Read())
            {
            ...
            SqlDataSource1.SelectCommand = "select * from services where service_id='" + TextBox1.Text + "'";
            GridView1.DataSourceID = "SqlDataSource1";
        }
        catch (Exception ex)
        {
    ...
    {
        TextBox4.Text = DropDownList2.SelectedValue.ToString();
    }
