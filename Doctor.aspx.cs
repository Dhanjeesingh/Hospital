...
public partial class Doctor : System.Web.UI.Page
{
    ...
    protected void Button2_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            SqlCommand cmd = conn.CreateCommand();
            cmd.CommandText = "insert into doctor values('" + TextBox1.Text + "','" + TextBox2.Text + "','" + TextBox3.Text + "','" + TextBox4.Text + "','" + TextBox5.Text + "','" + TextBox6.Text + "')";
            cmd.ExecuteNonQuery();
    ...
    protected void Button3_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            SqlCommand cmd = conn.CreateCommand();
            cmd.CommandText = "update doctor set contact_no='" + TextBox2.Text + "',email='" + TextBox3.Text + "',specialization='" + TextBox4.Text + "',gender='" + TextBox5.Text + "',hospital_id='" + TextBox6.Text + "' where doctor_id='" + TextBox1.Text + "' ";
            cmd.ExecuteNonQuery();
    ...
    protected void Button5_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            SqlDataSource1.SelectCommand = "select * from doctor where doctor_id='" + TextBox1.Text + "'";
            GridView1.DataSourceID = "SqlDataSource1";
        }
        catch (Exception ex)
        {
    ...
    protected void Button6_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            SqlCommand cmd = conn.CreateCommand();
            cmd.CommandText = "delete from doctor where doctor_id='" + TextBox1.Text + "'";
            cmd.ExecuteNonQuery();
